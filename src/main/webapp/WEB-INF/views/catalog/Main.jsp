...
<div id="Main">
    <div id="Sidebar">
        <div id="SidebarContent">
            <a
                ...
                href="${pageContext.request.contextPath}/catalog/viewCategory?categoryId=COWS"><img
    ...
    <div id="MainImage">
        <div id="MainImageContent">
            <map name="estoremap">
                <area alt= "US Birds" coords="72,2,280,250"
                ...
                <area alt="Cats" coords="225,240,295,310"
                    href="${pageContext.request.contextPath}/catalog/viewCategory?categoryId=COWS"
                    shape="RECT" />
                <area alt="US Birds" coords="280,180,350,250"
                    href="${pageContext.request.contextPath}/catalog/viewCategory?categoryId=BIRDS"
                    shape="RECT" />
            </map>
            <img height="355"
